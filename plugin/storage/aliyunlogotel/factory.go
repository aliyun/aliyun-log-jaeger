...
import (
	...
	logDepStore "github.com/jaegertracing/jaeger/plugin/storage/aliyunlogotel/dependencystore"
	logSpanStore "github.com/jaegertracing/jaeger/plugin/storage/aliyunlogotel/spanstore"
...
func (f *Factory) Initialize(metricsFactory metrics.Factory, logger *zap.Logger) error {
	...
	f.depLogstore = f.primaryConfig.DependencyLogstore

	if f.depProject == "" {
		f.depProject = f.spanProject
	}
...
func (f *Factory) CreateSpanWriter() (spanstore.Writer, error) {
	return logSpanStore.NewSpanWriter(
		...
		f.tagAppendRuleFileFlag,
		f.kindRewriteRuleFileFlag)
}
